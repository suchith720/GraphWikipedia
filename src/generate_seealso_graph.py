...
def create_graph(data_path, save_dir, matches=None, limit=None, save=True,
        tag_extractor=None, back=True, verbose=True):
...
if __name__ == '__main__':
    ...
    generate_graph = partial(create_graph, save_dir=results_dir,
                             matches=matches, limit=limit, save=True,
                             tag_extractor=tag_extractor, back=False)
