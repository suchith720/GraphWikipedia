...
class XCDataset:
    ...
    def load_idtotitle(self, save_dir, tag='', verbose=True):
        ...
        self.id_to_title = graph_data.parameters['id_to_title']
    ...
    def save_XY_text(self, save_dir, doc_to_rowindex, tag=''):
        ...
        self.save_XY_content(idtocontent_file, self.id_to_title, doc_to_rowindex, self.abstract)
    ...
    def load_classification_data(self, save_dir, verbose=True):
        ...
        self.data_splitter['classification'].load_data(save_dir, tag='seealso')
    ...
    def load_graph_data(self, save_dir, tag='', graph_type='articles', verbose=True):
        """
        Loading Graph
        """
        if verbose:
    ...
    def save_XCGraph_text(self, xc_dir, graph_type='articles', verbose=True):
        """
    ...
    def save_XCGraph_data(self, xc_dir, graph_type='articles', verbose=True):
        if verbose:
    ...
    def save_XCGraph(self, save_dir, xc_dir, tag='', graph_type='articles', verbose=True):
        """
        XC Graph
        """
    ...
    def create_XCData(self, save_dir, xc_dir, tag='', verbose=True):
        ...
        self.save_XCGraph(save_dir, xc_dir, tag=tag, graph_type='articles', verbose=verbose)
